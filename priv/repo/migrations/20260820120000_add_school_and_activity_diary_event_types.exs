defmodule Dosey.Repo.Migrations.AddSchoolAndActivityDiaryEventTypes do
  use Ecto.Migration

  def up do
    execute("ALTER TYPE diary_event_type ADD VALUE 'school'")
    execute("ALTER TYPE diary_event_type ADD VALUE 'activity'")
  end
